...
exports.connect = function (actions, config) {
    return function () {
        ...
        return Redux.connect(state_changers_1.stateChangersSelector.apply(void 0, args), actions_1.actionsSelector(Object.keys(actions).reduce(function (accumulator, key) {
