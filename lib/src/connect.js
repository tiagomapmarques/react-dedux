...
exports.connect = function (actions, config) {
    return function () {
        ...
        return ReactRedux.connect(state_changers_1.stateChangersSelector(configuration).apply(void 0, args), actions_1.actionsSelector(Object.keys(actions).reduce(function (accumulator, key) {
