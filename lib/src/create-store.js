...
exports.createStore = function (stateChangers, config) {
    return function (initialState) { return redux_1.createStore(reducer_1.combineReducers(stateChangers, config_1.getConfig(config)), initialState, redux_1.applyMiddleware.apply(void 0, middleware)); };
};
